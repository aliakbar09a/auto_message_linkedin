...
message = 'Thank you for connecting, Glad to connect, Congratulations for all that you do and especially for just who you are. My best wishes to you for your journeys into the future. Please stay in touch; taking unexpected folks in the road can create spectacular destinations.'
message_end = 'Best Regards, Ali.'
...
def writeMessage():
    # either write by copy pasting
    pg.hotkey('ctrl', 'v')
    # or write by typing
    #pg.typewrite(message, interval=0.01)
    # pg.press('enter')
    #pg.typewrite(message_end, interval=0.01)
